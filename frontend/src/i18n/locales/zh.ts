const zh = {
  ...
  customConfigs: {
    ...
    addProxyGroup: '添加代理组',
    proxyGroupsSaved: '代理组已保存',
    batchEditProxyGroups: '批量编辑',
    batchEditProxyGroupsTitle: '批量编辑代理组',
    batchEditProxyGroupsHint: '直接编辑代理组 YAML 列表，支持一次性添加或修改多个组。',
    batchEditProxyGroupsApply: '应用到配置',
    batchEditProxyGroupsReset: '重置',
    batchEditProxyGroupsError: '解析失败',
    ...
    ruleTextSwitchWithErrors: '已跳过 {{count}} 条无法解析的规则，其余规则已导入结构化视图',
  ...
  admin: {
    ...
    registrationControlDesc: '控制是否允许新用户自助注册，关闭后只有管理员可以创建新用户',
