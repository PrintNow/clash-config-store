const en = {
  ...
  auth: {
    ...
    registerClosed: 'Registration has been disabled by an administrator',
    usernameOptionalHint: 'Leave blank to derive a username from the part before @ in your email',
    usernameOptionalPlaceholder: 'Optional display name',
  },

  admin: {
    usersTitle: 'User management',
    usersSubtitle: 'Add, edit, or remove users; only super admins can change roles of others and delete admins',
    settingsTitle: 'Site settings',
    settingsSubtitle: 'Site-wide options such as open registration',
    allowRegistration: 'Allow open registration',
    allowRegistrationHint: 'When off, visitors cannot create new accounts from the register page',
    role: 'Role',
    ...
    updateUserSuccess: 'Saved',
    deleteUserSuccess: 'Deleted',
