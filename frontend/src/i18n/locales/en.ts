const en = {
  ...
  providers: {
    ...
    emptyTitle: 'Add your first provider',
    ...
    typeHttp: 'HTTP Subscription',
    typeInline: 'Private Nodes',
    selectType: 'Select Type',
    inlineNodes: 'Private Nodes',
  ...
  customConfigs: {
    ...
    proxyGroupsSaved: 'Proxy groups saved',
    batchEditProxyGroups: 'Batch Edit',
    batchEditProxyGroupsTitle: 'Batch Edit Proxy Groups',
    batchEditProxyGroupsHint: 'Edit the proxy groups YAML list directly. Add or modify multiple groups at once.',
    batchEditProxyGroupsApply: 'Apply to Config',
    batchEditProxyGroupsReset: 'Reset',
    batchEditProxyGroupsError: 'Parse Error',
    ...
    ruleTextSwitchWithErrors: 'Skipped {{count}} invalid rules; remaining rules imported to structured view',
  ...
  subscriptions: {
    ...
    componentConfig: 'Custom Config',
    componentRuleSets: 'Rule Sets',
    componentTemplate: 'Config Template',
    componentsNoProviders: 'No providers selected',
    componentsNoConfig: 'No config linked',
    componentsNoTemplate: 'No template linked',
  },

  accessLogs: {
    title: 'Access Logs',
    totalCount: '{{count}} records total',
    perPage: 'Per page',
    ip: 'IP Address',
    country: 'Country',
    city: 'City',
  ...
  admin: {
    ...
    registrationControlDesc: 'Control whether new users can self-register. When disabled, only admins can create users.',
